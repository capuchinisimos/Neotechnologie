...
$('#gallerydiv_4_2 .owl-carousel').owlCarousel({"loop":true,"items":1,"lazyLoad":true,"nav":false,"dots":false,"autoplay":true,"autoplayTimeout":4000,"smartSpeed":750,"lightbox":true,"mouseDrag":false,"animateOut":false,"animateIn":false});
...
google.maps.event.addDomListener(window, 'load', function(){
	...
	var Mp = new IdeoMap('map_BLOCK_4GV6K1CMV7_5e3c1abf9fb82'),
		mapsOptions = {
		    'item' : 'gmap_map_BLOCK_4GV6K1CMV7_5e3c1abf9fb82',
		    'zoom' : 15,
		    'mapType' : 'ROADMAP',
		    'background' : 'colors'
		},
		mapEl = document.getElementById('map_BLOCK_4GV6K1CMV7_5e3c1abf9fb82'),
		gmap_map_BLOCK_4GV6K1CMV7_5e3c1abf9fb82,
		observer;
	...
	if( hasIntersectionObserver ) {
		...
		observer = new IntersectionObserver(
		  function(entries, self) {
		    ...
		    if (isIntersecting) {
		    	gmap_map_BLOCK_4GV6K1CMV7_5e3c1abf9fb82 = Mp.initialize( mapsOptions );
		    	gmap_map_BLOCK_4GV6K1CMV7_5e3c1abf9fb82.addAddress({"name":"Eurotech Security","address":"17 Rue Des Pavillons, 93100 MONTREUIL SOUS BOIS","city":"MONTREUIL SOUS BOIS","country":"","zip":"93100","rawAddress":"","website":"","email":"","phone":""},"17 Rue Des Pavillons, 93100 MONTREUIL SOUS BOIS",{"lng":2.4556823,"lat":48.8704011}, 'standard', 'red', true);
