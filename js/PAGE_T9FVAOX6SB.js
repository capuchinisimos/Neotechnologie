...
$('#gallerydiv_10_2 .owl-carousel').owlCarousel({"loop":true,"items":1,"lazyLoad":true,"nav":false,"dots":false,"autoplay":true,"autoplayTimeout":4000,"smartSpeed":750,"lightbox":true,"mouseDrag":false,"animateOut":false,"animateIn":false});
$('#gallerydiv_9_2 .owl-carousel').owlCarousel({"loop":true,"items":1,"lazyLoad":true,"nav":false,"dots":false,"autoplay":true,"autoplayTimeout":4000,"smartSpeed":750,"lightbox":true,"mouseDrag":false,"animateOut":false,"animateIn":false});
/*!
...
$("#justified_BLOCK_4ZZX30PH3U").justifiedGallery({
		rowHeight : 160,
		maxRowHeight : -1,
		margins : 10,
		lastRow : 'justify',
		...
		var justifiedLightbox =  $("#justified_BLOCK_4ZZX30PH3U").find(".justifiedLightbox").imageLightbox(
		{
...
$("#justified_BLOCK_OUGQLU29RD").justifiedGallery({
		rowHeight : 160,
		maxRowHeight : -1,
		margins : 10,
		lastRow : 'justify',
		...
		var justifiedLightbox =  $("#justified_BLOCK_OUGQLU29RD").find(".justifiedLightbox").imageLightbox(
		{
		    onStart:     function() { ilbOverlayOn(); ilbNavigationOn( justifiedLightbox ); },
		    onEnd:       function() { ilbCaptionOff(); ilbOverlayOff(); ilbActivityIndicatorOff(); ilbNavigationOff(); },
		    onLoadStart: function() { ilbCaptionOff(); ilbActivityIndicatorOn(); },
...
owl.owlCarousel({
   ...
   responsive:{
    ...
    641:{ items: 2, margin: 10, slideBy: 1},
       1025:{ items: 2, margin: 20, slideBy: 1}
    }

});

var owl = $('.owl-carousel.header02 a.owlLightbox');
owl.each( function() {
    var link = $(this).attr('data-description');
    if(link === "") {
       // le champs description n’est pas renseigné dans l’admin
    } else {
        if (link.match("^http")) {
        $(this).removeClass().attr({'href': link, 'target':'_blank'});
        } else {
        $(this).removeClass().attr({'href': link, 'target':'_self'});
        }
    }
});
...
google.maps.event.addDomListener(window, 'load', function(){
	...
	var Mp = new IdeoMap('map_BLOCK_4GV6K1CMV7_5ed1b08e26ac2'),
		mapsOptions = {
		    'item' : 'gmap_map_BLOCK_4GV6K1CMV7_5ed1b08e26ac2',
		    'zoom' : 15,
		    'mapType' : 'ROADMAP',
		    'background' : 'colors'
		},
		mapEl = document.getElementById('map_BLOCK_4GV6K1CMV7_5ed1b08e26ac2'),
		gmap_map_BLOCK_4GV6K1CMV7_5ed1b08e26ac2,
		observer;
	...
	if( hasIntersectionObserver ) {
		...
		observer = new IntersectionObserver(
		  function(entries, self) {
		    ...
		    if (isIntersecting) {
		    	gmap_map_BLOCK_4GV6K1CMV7_5ed1b08e26ac2 = Mp.initialize( mapsOptions );
		    	gmap_map_BLOCK_4GV6K1CMV7_5ed1b08e26ac2.addAddress({"name":"Eurotech Security","address":"17 Rue Des Pavillons, 93100 MONTREUIL SOUS BOIS","city":"MONTREUIL SOUS BOIS","country":"","zip":"93100","rawAddress":"","website":"","email":"","phone":""},"17 Rue Des Pavillons, 93100 MONTREUIL SOUS BOIS",{"lng":2.4556823,"lat":48.8704011}, 'standard', 'red', true);
