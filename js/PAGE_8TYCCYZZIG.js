...
google.maps.event.addDomListener(window, 'load', function(){
	...
	var Mp = new IdeoMap('map_BLOCK_4GV6K1CMV7_5e3c12e17afbd'),
		mapsOptions = {
		    'item' : 'gmap_map_BLOCK_4GV6K1CMV7_5e3c12e17afbd',
		    'zoom' : 15,
		    'mapType' : 'ROADMAP',
		    'background' : 'colors'
		},
		mapEl = document.getElementById('map_BLOCK_4GV6K1CMV7_5e3c12e17afbd'),
		gmap_map_BLOCK_4GV6K1CMV7_5e3c12e17afbd,
		observer;
	...
	if( hasIntersectionObserver ) {
		...
		observer = new IntersectionObserver(
		  function(entries, self) {
		    ...
		    if (isIntersecting) {
		    	gmap_map_BLOCK_4GV6K1CMV7_5e3c12e17afbd = Mp.initialize( mapsOptions );
		    	gmap_map_BLOCK_4GV6K1CMV7_5e3c12e17afbd.addAddress({"name":"Eurotech Security","address":"17 Rue Des Pavillons, 93100 MONTREUIL SOUS BOIS","city":"MONTREUIL SOUS BOIS","country":"","zip":"93100","rawAddress":"","website":"","email":"","phone":""},"17 Rue Des Pavillons, 93100 MONTREUIL SOUS BOIS",{"lng":2.4556823,"lat":48.8704011}, 'standard', 'red', true);
