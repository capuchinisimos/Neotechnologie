...
$("#justified_BLOCK_W6H1ACCVMZ").justifiedGallery({
		rowHeight : 160,
		maxRowHeight : -1,
		margins : 10,
		lastRow : 'justify',
		...
		var justifiedLightbox =  $("#justified_BLOCK_W6H1ACCVMZ").find(".justifiedLightbox").imageLightbox(
		{
...
var IdeoMap = function(mapName){
  ...
  this.markerCount = 0;
  this.infoCount = 0;
  this.center = new google.maps.LatLng(14.6919, -17.447414);
...
google.maps.event.addDomListener(window, 'load', function(){
	...
	var Mp = new IdeoMap('map_BLOCK_4GV6K1CMV7_5e3d1ce7a4e76'),
		mapsOptions = {
		    'item' : 'gmap_map_BLOCK_4GV6K1CMV7_5e3d1ce7a4e76',
		    'zoom' : 15,
		    'mapType' : 'ROADMAP',
		    'background' : 'colors'
		},
		mapEl = document.getElementById('map_BLOCK_4GV6K1CMV7_5e3d1ce7a4e76'),
		gmap_map_BLOCK_4GV6K1CMV7_5e3d1ce7a4e76,
		observer;
	...
	if( hasIntersectionObserver ) {
		...
		observer = new IntersectionObserver(
		  function(entries, self) {
		    ...
		    if (isIntersecting) {
		    	gmap_map_BLOCK_4GV6K1CMV7_5e3d1ce7a4e76 = Mp.initialize( mapsOptions );
		    	gmap_map_BLOCK_4GV6K1CMV7_5e3d1ce7a4e76.addAddress({"name":"NEO TECHNOLOGIE","address":"CITE COMICO MERMOZ N°147, 12500 DAKAR","city":"DAKAR","country":"","zip":"93100","rawAddress":"","website":"","email":"","phone":""},"CITE COMICO MERMOZ N°147, 12500 DAKAR",{"lng":-17.44406,"lat":14.6937}, 'standard', 'red', true);
		...
		gmap_map_BLOCK_4GV6K1CMV7_5e3d1ce7a4e76 = Mp.initialize( mapsOptions );
		gmap_map_BLOCK_4GV6K1CMV7_5e3d1ce7a4e76.addAddress({"name":"NEO TECHNOLOGIE","address":"CITE COMICO MERMOZ N°147","city":"DAKAR","country":"","zip":"12500","rawAddress":"","website":"","email":"","phone":""},"CITE COMICO MERMOZ N°147, 12500 DAKAR",{"lng":-17.44406,"lat":14.6937}, 'standard', 'red', true);
	}
